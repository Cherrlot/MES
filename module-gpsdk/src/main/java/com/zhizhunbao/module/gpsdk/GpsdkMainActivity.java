...
import static com.zhizhunbao.lib.common.router.RouterKt.ROUTER_PATH_GPSDK;
import static com.zhizhunbao.module.gpsdk.Constant.ACTION_USB_PERMISSION;
import static com.zhizhunbao.module.gpsdk.Constant.MESSAGE_UPDATE_PARAMETER;
import static com.zhizhunbao.module.gpsdk.DeviceConnFactoryManager.ACTION_QUERY_PRINTER_STATE;
import static com.zhizhunbao.module.gpsdk.DeviceConnFactoryManager.CONN_STATE_FAILED;
...
@Route(path = ROUTER_PATH_GPSDK)
public class GpsdkMainActivity extends AppCompatActivity {
    private static final String	TAG	= "GpsdkMainActivity";
...
//        startActivityForResult( new Intent( this, BluetoothDeviceList.class ), Constant.BLUETOOTH_REQUEST_CODE );
    ...
    public void btnPrintXml( View view )
    {
        ...
        tableLayout.addView( ctv( GpsdkMainActivity.this, "红茶\n加热\n加糖", 8, 3 ) );
        tableLayout.addView( ctv( GpsdkMainActivity.this, "绿茶", 109, 899 ) );
        tableLayout.addView( ctv( GpsdkMainActivity.this, "咖啡", 15, 4 ) );
        tableLayout.addView( ctv( GpsdkMainActivity.this, "红茶", 8, 3 ) );
        tableLayout.addView( ctv( GpsdkMainActivity.this, "绿茶", 10, 8 ) );
        tableLayout.addView( ctv( GpsdkMainActivity.this, "咖啡", 15, 4 ) );
        tableLayout.addView( ctv( GpsdkMainActivity.this, "红茶", 8, 3 ) );
        tableLayout.addView( ctv( GpsdkMainActivity.this, "绿茶", 10, 8 ) );
        tableLayout.addView( ctv( GpsdkMainActivity.this, "咖啡", 15, 4 ) );
    ...
    protected void onActivityResult( int requestCode, int resultCode, Intent data )
    {
        ...
        if ( resultCode == RESULT_OK )
        {
            ...
            {
                /*蓝牙连接*/
//                case Constant.BLUETOOTH_REQUEST_CODE: {TODO:获取蓝牙设备
//                    closeport();
//                    /*获取蓝牙mac地址*/
...
//                }
                ...
                case Constant.USB_REQUEST_CODE: {
                    ...
                    /* 通过USB设备名找到USB设备 */
                    UsbDevice usbDevice = Utils.getUsbDeviceFromName( GpsdkMainActivity.this, usbName );
                    /* 判断USB设备是否有权限 */
    ...
    void sendLabel()
    {
        ...
        tsc.addBitmap( 10, 20, LabelCommand.BITMAP_MODE.OVERWRITE, 576, b );
            ...
            switch ( action )
            {
                ...
                case DeviceConnFactoryManager.ACTION_CONN_STATE:
                    ...
                    switch ( state )
                    {
                        ...
                        case CONN_STATE_FAILED:
                            Utils.toast( GpsdkMainActivity.this, getString( R.string.str_conn_fail ) );
                            /* wificonn=false; */
                            tvConnState.setText( getString( R.string.str_conn_state_disconnect ) );
                            break;
                        default:
                ...
                case ACTION_QUERY_PRINTER_STATE:
                    if ( counts >= 0 )
                    {
                        ...
                        {
                            printcount++;
                            Utils.toast( GpsdkMainActivity.this, getString( R.string.str_continuityprinter ) + " " + printcount );
                        }
                        if ( counts != 0 )
                        {
                            sendContinuityPrint();
        ...
        public void handleMessage( Message msg )
        {
            switch ( msg.what )
            {
                case CONN_STATE_DISCONN:
                    ...
                    {
                        DeviceConnFactoryManager.getDeviceConnFactoryManagers()[id].closePort( id );
                        Utils.toast( GpsdkMainActivity.this, getString( R.string.str_disconnect_success ) );
                    }
                    break;
                case PRINTER_COMMAND_ERROR:
                    Utils.toast( GpsdkMainActivity.this, getString( R.string.str_choice_printer_command ) );
                    break;
                case CONN_PRINTER:
                    Utils.toast( GpsdkMainActivity.this, getString( R.string.str_cann_printer ) );
                    break;
